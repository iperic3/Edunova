						...
						<li>
					   	 	<a href="#">Arhimed</a>
					   	 		<ul class="menu vertical">
			          				...
			          				<li><a href="<?php echo $putAplikacije; ?>Privatno/Razina/index.php">Razina</a></li>
			            			<li><a href="<?php echo $putAplikacije; ?>Privatno/Predmeti/index.php">Predmet</a></li>
			            			<li><a href="<?php echo $putAplikacije; ?>Privatno/Dvorana/index.php">Dvorana</a></li>
			            			<li><a href="<?php echo $putAplikacije; ?>/Privatno/Predavaci/index.php">Predavači</a></li>
			            			<?php endif; ?>
			            			<?php if(isset($_SESSION["logiran"]) && $_SESSION["logiran"]->uloga!=="polaznik"): ?>
			            			<li><a href="<?php echo $putAplikacije; ?>/Privatno/Polaznici/index.php">Polaznici</a></li>
			            			<li><a href="<?php echo $putAplikacije; ?>/Privatno/Termin/index.php">Termini</a></li>
			            			<?php endif; ?>
